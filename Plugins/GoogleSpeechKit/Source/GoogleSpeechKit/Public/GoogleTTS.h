...
struct FGoogleSpeechSynthesisParams
{
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "GoogleSpeechKit|TTS")
		TArray<EAudioEffectsProfile> AudioEffectsStack = { EAudioEffectsProfile::Wearable };
...
class UGoogleSpeechFunctionLibrary;
UCLASS()
...
public:
	...
	static UGoogleTTS* CallTTS(const FString& speech, FString language);
...
private:
    ...
    */
    ...
    TArray<FString> _languageValues;
